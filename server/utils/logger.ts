...
export const Log = (msgSource: MessageSources) => (msg: string) => {
  const date = new Date().toLocaleTimeString()
  console.log(`\x1b[32m${date} ${msgSource} ${msg}\x1b[0m`)
}
export const Warn = (msgSource: MessageSources) => (msg: string) => {
  const date = new Date().toLocaleTimeString()
  console.log(`\x1b[33m${date} ${msgSource} ${msg}\x1b[0m`)
}
export const Err = (msgSource: MessageSources) => (msg: string) => {
  const date = new Date().toLocaleTimeString()
