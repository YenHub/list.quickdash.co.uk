...
const NoteService = {
    ...
    /* tslint:disable */
    generateSecondary: (): string | undefined => {

        const { getWord, getWords } = NoteService;
        const testVal = random(100);
